...
from src.gui.interface import dialog, emotes
...
def setup_gui():
    ...
    entity_focus_indicator = pygame.transform.scale(entity_focus_indicator, (entity_focus_indicator.width * 2,
